<div class="card">
  ...
  <div class="card-body">
    ...
    <ul class="change-log-list mb20">
      <li>[Fixed] User IP When Running Sngine with Docker</li>
      <li>[Fixed] Watch Module When Newsfeed Caching Enabled</li>
      <li>[Fixed] User Access Checks When Approval System Enabled</li>
      <li>[Fixed] LiveStreaming Recording Issue</li>
      <li>[Fixed] Messages with Special Characters in Sngine Messaging Apps</li>
      <li>[Fixed] Minor Bugs</li>
    </ul>
    ...
    <ul class="change-log-list mb20">
      <li>[Fixed] Reels Issue When Newsfeed Caching Enabled</li>
    ...
    <ul class="change-log-list mb20">
      <li>[Fixed] PWA IOS Banner Issue</li>
      <li>[Fixed] Chunk Uploads Issue</li>
      <li>[Fixed] Backblaze Upload Issue</li>
      <li>[Fixed] Cash On Delivery Issue</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Newsfeed Merge</li>
      <li>[Added] Newsfeed Caching</li>
      <li>[Added] Enhance Newsfeed Infinite Scroll</li>
      <li>[Added] Popular Posts Interval</li>
      <li>[Added] Chunk Uploads</li>
      <li>[Added] Admin Ability To Select Chunk Size</li>
      <li>[Added] Image Compression with Cloud Storage</li>
      <li>[Added] Google Translation Besides Yandex</li>
      <li>[Added] Chat Translation Like Posts</li>
      <li>[Added] Paid Live Streaming</li>
      <li>[Added] Newsfeed Sorting Shortcut</li>
      <li>[Added] Wallet Payment For Marketplace</li>
      <li>[Added] Cash On Delivery In Marktplace</li>
      <li>[Added] Admin Ability To Turn Cash On Delivery On/Off</li>
      <li>[Added] Censored Domains</li>
      <li>[Added] Admin Ability To Turn Censored Domains On/Off</li>
      <li>[Added] Manage Moderators Permissions From Admin Panel</li>
      <li>[Added] Hide From Suggestions List Privacy Settings</li>
      <li>[Added] Post Option For Ads System</li>
      <li>[Added] LiveKit For Audio/Video Calls</li>
      <li>[Added] Agora For Audio/Video Calls</li>
      <li>[Added] More 4 Places For Widgets</li>
      <li>[Added] New Option To Crop Cover Picture</li>
      <li>[Added] Reels Available For Non-Logged In Users</li>
      <li>[Added] Newsfeed Scrolling Enhancement</li>
      <li>[Added] MercadoPago Payment</li>
      <li>[Added] In Mobile Swipe Left To Back</li>
      <li>[Added] Admin Ability To Turn Mobile Swipe On/Off</li>
      <li>[Added] Cronjob System</li>
      <li>[Added] Admin Ability To Turn Cronjob System On/Off</li>
      <li>[Added] My Offers To Side Menu</li>
      <li>[Added] My Jobs To Side Menu</li>
      <li>[Added] My Courses To Side Menu</li>
      <li>[Added] Mask Uploaded File Path</li>
      <li>[Added] Admin Ability To Turn Mask Uploaded File Path On/Off</li>
      <li>[Added] [Verified, City, Country] Filters In People Finder</li>
      <li>[Added] Admin Ability To Disable Default YouTube Player</li>
      <li>[Added] HEIF/HEIC Images Support</li>
      <li>[Added] Posts Schedule System</li>
      <li>[Added] Posts Schedule Permission To Permissions Groups</li>
      <li>[Added] Cloudflare Turnstile CAPTCHA</li>
      <li>[Added] Custom Affiliates Levels (System Level)</li>
      <li>[Added] Custom Affiliates Levels (Permissions Group Level)</li>
      <li>[Added] Custom Affiliates Levels (User Level)</li>
      <li>[Added] Content Monetization To Affiliates System</li>
      <li>[Added] Pay The Referrer Who (Invited The Buyer|Invited The Seller)</li>
      <li>[Added] Password Complexity System</li>
      <li>[Added] Whitelist Providers</li>
      <li>[Added] HLS/M3U8 Support For Video Player</li>
      <li>[Added] Marketplace Automatic Delivery</li>
      <li>[Added] Marketplace Automatic Delivery To Garbage Collector</li>
      <li>[Added] Marketplace Automatic Delivery To Cronjob</li>
      <li>[Added] Show/Hide Login Password</li>
      <li>[Added] Announcement For All Visitors & Members</li>
      <li>[Added] Reset All Users Wallet Balance & Transactions To Garbage Collector</li>
      <li>[Added] Delete All Fake Users To Garbage Collector</li>
      <li>[Added] Delete All Fake Pages To Garbage Collector</li>
      <li>[Added] Delete All Fake Groups To Garbage Collector</li>
      <li>[Added] Copy The Invitation Link</li>
      <li>[Added] Smooth Scroll To New Posts</li>
      <li>[Added] In Mobile Show All Settings Once Click Settings</li>
      <li>[Added] In Mobile Show All Messages Once Click Messages</li>
      <li>[Added] Publisher Embded Error Message Instead Of Modal</li>
      <li>[Added] Change Profile, Page, Group & Event Layout Order</li>
      <li>[Added] Delete Publisher Removed Uploads (Photos, Videos, Audios, Files) From Server</li>
      <li>[Added] Ads Author Can See His Ads</li>
      <li>[Added] Location Search For Products</li>
      <li>[Added] User Ability To Lock Paid Post With Files</li>
      <li>[Added] User 'Getting Started' toggle in admin user settings</li>
      <li>[Added] Offers Read Permission</li>
      <li>[Added] Select Custom User Group Now Mandatory If Enabled</li>
      <li>[Added] Merits System</li>
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] PayPal Duplicated Payments Log</li>
      <li>[Fixed] Donate With Wallet Amount Issue</li>
      <li>[Fixed] Wallet Transfer Max Set To 0 Issue</li>
      <li>[Fixed] Reels Reactions By Click In Desktop</li>
      <li>[Fixed] Up/Down Keys Popup Error</li>
      <li>[Fixed] Stripe Recurring Payments</li>
      <li>[Fixed] Video Quality Selector</li>
      <li>[Fixed] Show All (Pages, Groups, Events) When Share Post</li>
      <li>[Fixed] Show All (Pages, Groups, Events) In Ads Manager</li>
      <li>[Fixed] Marketplace Order Payment Issue</li>
      <li>[Fixed] Improve Transaction Handling In CoinPayments Webhook</li>
      <li>[Fixed] Discover & Popular Posts With Country Filter</li>
      <li>[Fixed] Notifications Counter Issue</li>
      <li>[Fixed] Posts Loader Colors In Dark Mode</li>
      <li>[Fixed] Pager Colors In Dark Mode</li>
      <li>[Fixed] Events Images in UI-Box Listing</li>
      <li>[Fixed] Edit Reels Comments/Replies Issue</li>
      <li>[Fixed] Show Course Start & End Date</li>
      <li>[Fixed] User Name In Activation Email Issue</li>
      <li>[Fixed] Stories With Friends System Disabled Issue</li>
      <li>[Fixed] Validate Amount For Wallet Operations To Ensure Non-Negative Values</li>
      <li>[Fixed] Update user access checks to allow logged-in users to bypass public system restrictions</li>
      <li>[Fixed] Disable Pull To Refresh in Android App for REELS</li>
      <li>[Fixed] Emojis & Stickers Space Issue</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Push Notifications For IOS App</li>
      <li>[Added] Chat Push Notifications</li>
      <li>[Added] Chat Privacy (Everyone, Friends, No One)</li>
      <li>[Added] Admin Ability To Disable Chat Module Completely</li>
      <li>[Added] Switching Camera in Live Streaming</li>
      <li>[Added] Show Camera Preview Before Live Streaming</li>
      <li>[Added] Enhanced Live Streaming Resolution To 720p+</li>
      <li>[Added] New Mobile UI</li>
      <li>[Added] Changed The Video Player To Plyr Instead Of Video.JS</li>
      <li>[Added] Abbreviated Counters</li>
      <li>[Added] Changed Posts With Map To Interactive Map Instead of Images</li>
      <li>[Added] Subscription Button In Profile</li>
      <li>[Added] Subscription Button In Page</li>
      <li>[Added] Subscription Button In Group</li>
      <li>[Added] Create Post To Quick Add Menu</li>
      <li>[Added] Create Live To Quick Add Menu</li>
      <li>[Added] Wallet Recharge Option Directly With Error Of No Funds Available</li>
      <li>[Added] Share to Timeline, Pages, Groups Or Events in Share Plugin</li>
      <li>[Added] Replaced PRO Badge With Icon</li>
      <li>[Added] Users Approval System</li>
      <li>[Added] Email Notifications For Users Approval System</li>
      <li>[Added] Watch Module Showing All Videos</li>
      <li>[Added] Detect Visitor Country Automatically For Watch Module</li>
      <li>[Added] Create Products In Pages</li>
      <li>[Added] Create Products In Groups</li>
      <li>[Added] Create Products In Events</li>
      <li>[Added] Search Profile Posts</li>
      <li>[Added] Search Page Posts</li>
      <li>[Added] Search Group Posts</li>
      <li>[Added] Search Event Posts</li>
      <li>[Added] Country Filter For Pages</li>
      <li>[Added] Country Filter For Groups</li>
      <li>[Added] Country Filter For Events</li>
      <li>[Added] Country Filter For Jobs</li>
      <li>[Added] Country Filter For Offers</li>
      <li>[Added] Country Filter For Courses</li>
      <li>[Added] Country Filter For Blogs</li>
      <li>[Added] Country Filter For Funding</li>
      <li>[Added] Yandex Cloud Storage Support</li>
      <li>[Added] Flutterwave Payment Gateway</li>
      <li>[Added] NyFatoorah Payment Gateway</li>
      <li>[Added] Epayco Payment Gateway</li>
      <li>[Added] Verotel Payment Gateway</li>
      <li>[Added] Stripe Payment Element</li>
      <li>[Added] PayPal Payouts Integration</li>
      <li>[Added] Updated Cashfree APIs To Latest Version</li>
      <li>[Added] Marketplace Accept Payments Instead Of Wallet Credit</li>
      <li>[Added] Donate Using Wallet Balance</li>
      <li>[Added] Admin Ability To Turn Donate Using Wallet Balance On/Off</li>
      <li>[Added] Static Pages With Redirect URLs</li>
      <li>[Added] Static Pages Added to Sidebar Menu</li>
      <li>[Added] Widgets Langauges</li>
      <li>[Added] Widgets Audience</li>
      <li>[Added] Points Transactions Log In User Settings</li>
      <li>[Added] Points/Comment For Post Author</li>
      <li>[Added] Points/Reaction For Post Author</li>
      <li>[Added] Admin Ability To Disable Points Monetization</li>
      <li>[Added] Custom Points System For Each Permissions Groups</li>
      <li>[Added] Watermark Using Username</li>
      <li>[Added] Monetization Earnigns In User Settings Page</li>
      <li>[Added] Paid Post Blurred Preview Image</li>
      <li>[Added] Subscriptions Post Blurred Preview Image</li>
      <li>[Added] Paid Post Will Paid Post For Subscribers Too</li>
      <li>[Added] Admin Ability To Maximum Total Upload Size</li>
      <li>[Added] Admin Ability To Set Default Privacy For New Users</li>
      <li>[Added] Admin Ability To Turn Username Changes Off</li>
      <li>[Added] Admin Ability To Disable Profile Updates Posts (Profile Pictures & Covers)</li>
      <li>[Added] Admin Ability To Set Maximum Paid Post Price</li>
      <li>[Added] Admin Ability To Set Maximum Monetization Plan Price</li>
      <li>[Added] Admin Ability To Disable Download Images</li>
      <li>[Added] Admin Ability To Disable Mouse Right Click</li>
      <li>[Added] Admin Ability To Resend Activation Emails</li>
      <li>[Added] User Can Select Custom User Group While Sign Up</li>
      <li>[Added] Admin Ability To Turn User Can Select Custom User Group On/Off</li>
      <li>[Added] Admin Ability To Turn Show Custom User Group Badge On/Off</li>
      <li>[Added] Manage Auto Connected Nodes In Getting Started</li>
      <li>[Added] Detect Visitor Langauge Automatically</li>
      <li>[Added] Admin Ability To Disable Auto Langauge Automatically</li>
      <li>[Added] Courses Module</li>
      <li>[Added] Event Sponsor For System Admins</li>
      <li>[Added] Pages Business ID</li>
      <li>[Added] Admin Ability To Turn Pages Business ID On/Off</li>
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] Group Invitation System</li>
      <li>[Fixed] Stripe Recurring Payments Issue</li>
      <li>[Fixed] Blog Views Counter</li>
      <li>[Fixed] Hide Market Withdrawal Requests If Cart Disabled</li>
      <li>[Fixed] Page Info With Reviews Notifcations</li>
      <li>[Fixed] Login As with Demo Account Bug</li>
      <li>[Fixed] Settings Page Access With Packages Set As Subscriptions Only</li>
      <li>[Fixed] LinkedIn Social Login</li>
      <li>[Fixed] Close Button In Dark Mode</li>
      <li>[Fixed] MSG91 SMS Issue</li>
      <li>[Fixed] Video Player In Fullscreen Mode</li>
      <li>[Fixed] Reset reCAPTCHA after form submission</li>
      <li>[Fixed] Find People Will Find All Users Now</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Events Reviews</li>
      <li>[Added] Admin Ability To Turn Events Reviews On/Off [Admin Panel]</li>
      <li>[Added] Posts Reviews</li>
      <li>[Added] Admin Ability To Turn Posts Reviews On/Off [Admin Panel]</li>
      <li>[Added] Paid Chat Messages For Monetizations</li>
      <li>[Added] Paid Audio/Video Calls For Monetizations</li>
      <li>[Added] Publish Posts Permission To Permissions Groups</li>
      <li>[Added] Create Jobs Permission To Permissions Groups</li>
      <li>[Added] Create Offers Permission To Permissions Groups</li>
      <li>[Added] Users Ability To Publish Jobs</li>
      <li>[Added] Users Ability To Publish Offers</li>
      <li>[Added] Post Approval System</li>
      <li>[Added] Email Notifications For Post Approval System</li>
      <li>[Added] Email Notifications For Verification Requests</li>
      <li>[Added] Adult Content Mode</li>
      <li>[Added] Verification Required For Publishing Posts</li>
      <li>[Added] Verification Required For Monetization</li>
      <li>[Added] Verification Required For Adult Content</li>
      <li>[Added] Payments VAT System</li>
      <li>[Added] Payments VAT System By User Country</li>
      <li>[Added] Payments Fees System</li>
      <li>[Added] Watermark Videos</li>
      <li>[Added] Combo Post</li>
      <li>[Added] Affiliates System Working With Bank Transfers</li>
      <li>[Added] Affiliates Working Recursively With Pro Packages</li>
      <li>[Added] Original Price To Offers</li>
      <li>[Added] Multiple Images To Offers</li>
      <li>[Added] Offers Expire Date Now Optional</li>
      <li>[Added] CV Attachment To Job Application</li>
      <li>[Added] Pages Events</li>
      <li>[Added] Admin Ability To Turn Pages Events On/Off [Admin Panel]</li>
      <li>[Added] List Non-Activated Users in Admin Panel [Admin Panel]</li>
      <li>[Added] List Users Stats In Admin Panel [Admin Panel]</li>
      <li>[Added] Export To CSV For Users Module [Admin Panel]</li>
      <li>[Added] Clear Compiled Templates From Garbage Collector [Admin Panel]</li>
      <li>[Added] Admin Ability To Turn Market Shopping Cart On/Off [Admin Panel]</li>
      <li>[Added] Unique Post Views System [Admin Panel]</li>
      <li>[Added] Login As for Admins Only [Admin Panel]</li>
      <li>[Added] Earnings Dashboard [Admin Panel]</li>
      <li>[Added] Visitors Insights [Admin Panel]</li>
      <li>[Added] New Landing Page</li>
      <li>[Added] Updated All Social Media Icons</li>
      <li>[Added] DigitalOcean Spaces S3 Compatibility</li>
      <li>[Fixed] Paid Posts Images Viewable While Slide Right/Left</li>
      <li>[Fixed] Paid Posts OG Tags Issue</li>
      <li>[Fixed] Fluid Videos Aspect Ration</li>
      <li>[Fixed] Update lightbox image download link</li>
      <li>[Fixed] Remove Top Friends From Other Places Than Profile Friends</li>
      <li>[Fixed] Delete Blog Cover Image Issue</li>
      <li>[Fixed] 2FA When System Turned Off</li>
      <li>[Fixed] Minor Bugs</li>
    </ul>
    ...
    <ul class="change-log-list mb20">
      <li>[Fixed] Paid Posts Issues</li>
      <li>[Fixed] Single Photo Comments Count Issue</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Allow Paid Post for Blogs</li>
      <li>[Added] Posts For Subscribers Only</li>
      <li>[Added] Allow Subscribers Only for Blogs</li>
      <li>[Added] Allow Subscribers Only for Live Stream</li>
      <li>[Added] Subscribers Only On/Off from Edit Post Menu</li>
      <li>[Added] Free Trial Monetization Plans</li>
      <li>[Added] Minutes & Hours Monetization Plans</li>
      <li>[Added] Share Screen Live Streaming</li>
      <li>[Added] Quick Tips Buttons in Live Posts</li>
      <li>[Added] Chat Box for Groups</li>
      <li>[Added] Chat Box for Events</li>
      <li>[Added] Pages Reviews Module</li>
      <li>[Added] Earnings Dashboard for Paid Movies System [Admin Panel]</li>
      <li>[Added] Update Factory Reset To Reset System Options [Admin Panel]</li>
      <li>[Added] Garbage Collector for Orphaned Posts Data [Admin Panel]</li>
      <li>[Added] FFmpeg Video Resolutions [Admin Panel]</li>
      <li>[Added] Videos Fluid Mode [Admin Panel]</li>
      <li>[Added] Disable Genders [Admin Panel]</li>
      <li>[Added] Unsubscribe Pro Package From User's Settings</li>
      <li>[Added] Manage Subscriptions From Profile</li>
      <li>[Added] Manage User's Subscriptions Privacy From Privacy Settings</li>
      <li>[Added] User Ability to Share Profile</li>
      <li>[Added] User Ability to Share Page</li>
      <li>[Added] User Ability to Share Group</li>
      <li>[Added] User Ability to Share Event</li>
      <li>[Added] Hide Videos Tab from Profile if Videos Upload Disabled</li>
      <li>[Added] Hide Videos Tab from Page if Videos Upload Disabled</li>
      <li>[Added] Hide Videos Tab from Group if Videos Upload Disabled</li>
      <li>[Added] Hide Videos Tab from Event if Videos Upload Disabled</li>
      <li>[Added] Seller Info in the Invoice</li>
      <li>[Added] Search Option in Mobile View If Enabled</li>
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] Emojis Insertion at End of Textarea</li>
      <li>[Fixed] Buy Now Shows Login Modal for Visitor</li>
      <li>[Fixed] Permissions Group Delete</li>
      <li>[Fixed] Delete User Posts When Delete User Account</li>
      <li>[Fixed] Marketplace Total Price</li>
      <li>[Fixed] Remove Select Currency From Products</li>
      <li>[Fixed] Paid Movies For Public Issue</li>
      <li>[Fixed] Paid Movies Price Issue</li>
      <li>[Fixed] Muted Videos When Auto-Play Off</li>
      <li>[Fixed] Scraper m3u8 files Issue</li>
      <li>[Fixed] Zoom In Mobile Browser While Publish Post|Comment</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Send Tips in Profiles</li>
      <li>[Added] User ability to turn Send Tips in his profile On/Off [User Settings]</li>
      <li>[Added] Tips Button in Pages</li>
      <li>[Added] Page's Admin ability to turn Send Tips in his page On/Off [Page Settings]</li>
      <li>[Added] Products Limits Per Package</li>
      <li>[Added] Business Tax Info, Address, Website with Pages Verification Requests</li>
      <li>[Added] Change Profile Cover from Old Photos</li>
      <li>[Added] Change Page Cover from Old Photos</li>
      <li>[Added] Change Group Cover from Old Photos</li>
      <li>[Added] Change Event Cover from Old Photos</li>
      <li>[Added] Hide Permissions For Disabled Modules in Packages</li>
      <li>[Added] Enhanced The Search System</li>
      <li>[Added] Products Tab in Profile Page</li>
      <li>[Added] Manage Profile Top Photos</li>
      <li>[Added] Manage Profile Top Friends</li>
      <li>[Added] Photo Link Copy When Sharing Single Photo</li>
      <li>[Added] Create Funding from Publisher</li>
      <li>[Added] Page Description Supports Multiple Lines</li>
      <li>[Added] Group Description Supports Multiple Lines</li>
      <li>[Added] Event Description Supports Multiple Lines</li>
      <li>[Added] Show User's Marketplace Balance in Admin Panel</li>
      <li>[Added] Show User's Funding Balance in Admin Panel</li>
      <li>[Added] Show User's Monetization Balance in Admin Panel</li>
      <li>[Added] Enhanced Blogs Tags System</li>
      <li>[Added] More Zones for Wasabi Settings</li>
      <li>[Added] Upgrade FontAwesome to v6+</li>
      <li>[Added] Upgrade Installer Wizard to v5+</li>
      <li>[Added] Upgrade Updater Wizard to v5+</li>
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] Change OG-Image with Video Thumbnail</li>
      <li>[Fixed] Exclude None-Activated Users From New People</li>
      <li>[Fixed] Exclude Super Admin From New People</li>
      <li>[Fixed] Ads for Pages & Groups</li>
      <li>[Fixed] Noty Notification not Clickable</li>
      <li>[Fixed] Pro Packages Price Format</li>
      <li>[Fixed] Profiles/Pages/Groups/Events UI make info first</li>
      <li>[Fixed] Stories ADS Last More Than 24 Hours</li>
      <li>[Fixed] Funding Post's Title Open New Window</li>
      <li>[Fixed] Change People UI Make Search At Bottom</li>
      <li>[Fixed] Hide Boosted Pages if Pages Disabled From Sidebar Menu</li>
      <li>[Fixed] Super Admin Can Change His User Group</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Monetization Custom Plans Module</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Publish Blogs Inside Pages</li>
      <li>[Added] Publish Blogs Inside Groups</li>
      <li>[Added] Publish Blogs Inside Events</li>
      ...
      <li>[Added] New Ads Positions Under The Post & Blog</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Fixed] Blog Category Name Translation</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Translate Blog Categories in Blog Page</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Manage Blogs from Admin Panel [Admin Panel]</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Fixed] UTF-8 Tags in Blogs</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Admin ability to turn blogs for users on/off [Admin Panel]</li>
      <li>[Added] Delete blog button from blog page</li>
      ...
      <li>[Added] Ads in Blog</li>
      <li>[Added] Widget in Blog</li>
    ...
    <ul class="change-log-list mb20">
      ...
      <li>[Added] Blogs in search results</li>
      <li>[Added] Blog cover in blog content</li>
