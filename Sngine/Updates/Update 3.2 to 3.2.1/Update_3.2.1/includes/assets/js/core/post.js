...
$(function() {
                ...
                $.post(api['posts/scraper'], {'query': query}, function(response) {
                    ...
                    if(response.callback) {
                        ...
                        if(response.link['source_type'] == "photo") {
                            ...
                            /* media */
                            if(response.link['source_provider'] == "YouTube" || response.link['source_provider'] == "Facebook" || response.link['source_provider'] == "Twitch" || response.link['source_provider'] == "Vimeo") {
    ...
    async function join(channel_name, token, uid) {
        /* init agora client */
        agora_client.setClientRole("audience");
