...
try {
	...
	switch ($_POST['handle']) {
		case 'packages':
			...
			// get paystack link
			$link = paystack("packages", $package['price'], $package['package_id']);
			break;
		...
		case 'wallet':
			...
			// get paystack link
			$link = paystack("wallet", $_POST['price']);
			break;
		...
		case 'donate':
			...
			// get paystack link
			$link = paystack("donate", $_POST['price'], $_POST['post_id']);
			break;
