    ...
    <div class="card-header with-icon">
        {if $sub_view == "edit_event"}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/events" class="btn btn-sm btn-light">
        ...
        {elseif $sub_view == "categories"}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/events/add_category" class="btn btn-sm btn-primary">
        ...
        {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/events/categories" class="btn btn-sm btn-light">
                    <i class="fa fa-arrow-circle-left"></i><span class="ml5 d-none d-lg-inline-block">{__("Go Back")}</span>
                </a>
            </div>
        {/if}
                    ...
                    <tbody>
                        {foreach $rows as $row}
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/admincp/events/edit_event/{$row['event_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                    ...
                    <tbody>
                        {foreach $rows as $row}
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/admincp/events/edit_category/{$row['category_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
