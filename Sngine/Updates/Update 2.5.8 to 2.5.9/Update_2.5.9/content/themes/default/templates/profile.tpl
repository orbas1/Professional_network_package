                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    {if $profile['user_social_google']}
                                        <a target="_blank" href="{$profile['user_social_google']}" class="btn btn-sm btn-rounded btn-social-icon btn-google">
                                ...
                                <div class="card-body ptb10 plr10">
                                    <div class="row no-gutters">
                                        {foreach $profile['events'] as $_event}
                                            <div class="col-3 col-lg-4">
                                                <div class="mtb5 mlr5">
                                                    <a class="user-box" style="position: relative; padding-top: 100%; margin: 0; margin-bottom: 20px;" href="{$system['system_url']}/events/{$_event['event_id']}">
                                                        <img style="position: absolute; top: 0; left: 0; bottom: 0; right: 0; object-fit: cover;" alt="{$_event['event_title']}" src="{$_event['event_picture']}" />
                                                        <div style="position: absolute; left: 0; right: 0;" class="name" title="{$_event['event_title']}">
                                                            {$_event['event_title']}
                                                        </div>
                                                    </a>
                                                </div>
